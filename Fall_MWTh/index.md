# CMPS 147 Fall 2015 - Section 03

## Introduction to Computer Science 1

**Meeting Time:** Monday, Wednesday, Thursday 8:30am-9:40am
**Location:** ASB 429

<p class="highlight">
Please note this is a hybrid course, we will not meet each of the allocated class sessions.  Please read this document, and the schedule, very carefully so you know when we will be meeting as a class.
</p>
...
Hybrid courses substitute portions of regularly scheduled class time with online lectures.  This means that although this course is scheduled to meet three mornings each week, **we will not**.  That also means you will need to be responsible and disciplined with keeping up with the video lectures I'll provide (below).  The video lectures in the class largely replace the in-class lectures (they are not **optional!**)

If you have never taken an hybrid course, you may be surprised how easy it is to fall behind.  When we meet in class, I will assume you've already viewed the assigned lectures online.  Most in-class meetings will be doing hands-on programming, using the concepts from the assigned video lectures.  I will be there to assist you, but it is your responsibility to have already digested and absorbed the material.  It is also immensly important that you attend in-class meetings when they are scheduled - so please stay informed by reading your email, reading this site, and reading the content on Moodle!  
...
The listing below contains links to each module.  Moodle also contains these links, organized by the week's they are to be reviewed.
...
## Labs (In-Class)
Roughly once a week (sometime twice, sometimes we'll skip a week), we will have in-class lab sessions where you will be given a lab assignment to complete.  These labs are described in the lecture slides, and it is acceptable for you to work ahead if you wish, however your attendance at the in-class lab sessions are *mandatory*.
...
| [Lab 2](https://docs.google.com/presentation/d/1fbiI6n8cNwljDS2yUH-PR_Kr1UpfdgKizWuqt-5IIFE/pub?start=false&loop=false&delayms=3000&slide=id.g33b4d3301_0137) | 9/10/2015 (9am)
| [Lab 3](https://docs.google.com/presentation/d/1HYuMZ8fHBVKqX1GziqB4pWJLyaPePKVJxOYYjYUBCNM/pub?start=false&loop=false&delayms=3000#slide=id.g33b873ba6_081) |  9/15/2015  (9am)
...
| [Lab 5](https://docs.google.com/presentation/d/1E-4ps_HhL6_UeKZKHEBx2UNV11EVhyvkRmVxasE_llE/pub?start=false&loop=false&delayms=3000#slide=id.g180824865_065) | 9/29/2015 (9am)
| [Lab 6](https://docs.google.com/presentation/d/1oGnyXfB5INoikSthq8oBvni4HPDv9iRoCaY6e6tnxk4/pub?start=false&loop=false&delayms=3000#slide=id.g180819e3b_078) | 10/13/2015 (9am)
| [Lab 7](https://docs.google.com/presentation/d/1n_3UkxEgMk694mrvFymf7t3P9iNkizZXvES9NOrox-g/pub?start=false&loop=false&delayms=3000#slide=id.g180825c8b_092) | 10/16/2015 (9am)
| [Lab 8](https://docs.google.com/presentation/d/1Y5PBeJYMusRU-4FYvzM60_MiFaqRyGrKSTswcsF-bFQ/pub?start=false&loop=false&delayms=3000#slide=id.g180b604f6_093) | 10/29/2015 (9am)
| [Lab 9](https://docs.google.com/presentation/d/1xQrWleG0zduXaUqjjJbz4PkYzH2COPEaOIXizX2Smxk/pub?start=false&loop=false&delayms=3000#slide=id.g18155d4d1_031) | 11/4/2015 (9am)
| [Lab 10](https://docs.google.com/presentation/d/1B0iIV36zV3dGPDOR9dkzhWFzK4cd-kx2JdyxafbDVIs/pub?start=false&loop=false&delayms=3000#slide=id.g18157c949_018) | 11/19/2015 (9am)
| [Lab 11](https://docs.google.com/presentation/d/1fAToX2anOHHDD7cOO_waRaIEc611T2dpaJOkjogtINI/pub?start=false&loop=false&delayms=3000#slide=id.g18156708b_0105) | 12/8/2015 (9am)
...
## Recitations
In some of the in-class meetings, I will lecture for either part of, or the entire session.  These are marked on the calendar below as "recitation".  Again, you are 100% expected to have worked though the specified modules for the given in-class meeting, recitations are scheduled so I can augment the modules, address common questions, and provide additional insights on the material.

# Meeting Calendar
The calendar below is subject to change - please make sure you read your emails!  Note, while this course is schedule to meet three times a week, we WILL NOT - as this is a HYBRID course.  The class will meet in ASB 429 ONLY on the days designated below.

<div style="margin:0px;padding:0px;overflow:hidden">
    <iframe src="https://docs.google.com/spreadsheets/d/1yuFdyuPs8xX86QYmTJeT3RTfXILqoPoBnAj8wFi1BTQ/pubhtml?gid=683451890&amp;single=true&amp;widget=true&amp;headers=false" frameborder="0" style="overflow:hidden;overflow-x:hidden;overflow-y:hidden;height:1200px;width:100%;" height="100%" width="100%"></iframe>
</div>
...
| [Homework 2](../hw2/Homework2.html) | 10/19/2015 
| [Homework 3](../hw3/Homework3.html) |  11/9/2015 
...
You will have 70 minutes to complete all quizzes, and three hours to complete the final exam.

|  | Modules Covered | Date
|--|---|---
| **Quiz 1** | Modules  1-9  |  9/23/2015 
| **Quiz 2** | Modules 10-15 |  10/7/2015
| **Quiz 3** | Modules 16-18 | 10/22/2015
| **Quiz 4** | Modules 19-24 | 11/12/2015
| **Quiz 5** | Modules 25-28 |  12/2/2015
